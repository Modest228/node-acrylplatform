...
1.5.Действующая редакция Политики размещена на Сайте https://node.acrylplatform.com/privacy
<br /><br />
...
3.Персональные данные передаются в электронной форме по каналам связи сети «Интернет» для реализации целей, указанных в настоящем Согласии, Политике конфиденциальности <a href="https://node.acrylplatform.com/privacy">https://node.acrylplatform.com/privacy</a> и могут быть переданы третьим лицам, в соответствии с разделом 4 Политики конфиденциальности, для реализации указанных целей.<br /><br />
